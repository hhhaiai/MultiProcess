...
//  }
  ...
  public static class OCTemp {
    ...
    public static class Column {
      public static final String ID = "id";
      // 应用包名
      public static final String APN = "oct_a";
      // 应用名称
      public static final String AN = "oct_b";
      // 开始时间
      public static final String AOT = "oct_c";
      // 结束时间
      public static final String ACT = "oct_d";
      // 应用打开关闭次数
      public static final String CU = "oct_e";
      // 日期
      public static final String DY = "oct_f";
      // insert 的时间
      public static final String IT = "oct_g";
      // 应用版本信息
      public static final String AVC = "oct_h";
      // 网络类型
      public static final String NT = "oct_i";
      // 应用切换类型，1-正常使用，2-开关屏幕切换，3-服务重启
      public static final String AST = "oct_j";
      // 应用类型
      public static final String AT = "oct_k";
      // OC采集来源，1-getRunningTask，2-读取proc，3-辅助功能，4-系统统计
      public static final String CT = "oct_l";
      // 时间段标记
      public static final String TI = "oct_m";
      // 存储标记，默认为 0，上传读取后修改为 1
      public static final String ST = "oct_n";
      // 应用运行状态，默认值 0，正在运行为 1
      public static final String RS = "oct_o";
