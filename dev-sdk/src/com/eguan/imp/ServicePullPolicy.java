...
public class ServicePullPolicy {
    ...
    // public ContentValues transferCV(Context mContext) throws
    // EGDBEncryptException{
    // ContentValues cv = new ContentValues();
    // cv.put(EGServicePullPolicyTable.PACKAGE_NAME,
    // EncryptUtils.encrypt(mContext,packageName));
