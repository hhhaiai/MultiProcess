...
public class AppProcessManager {
    ...
    private void dealAppProcess() {
        ...
        if (prePackageNames.isEmpty()) {
            ...
            List<String> preCopy = new ArrayList<String>(prePackageNames);
            ...
            List<String> nowCopy = new ArrayList<String>(nowPackageNames);
    ...
    private void dealOCTime() {
        if (nowPackageNames.size() == 0)
            return;
        final ArrayList<OCTimeBean> ocTimeBeans = new ArrayList<OCTimeBean>();
        for (String packageName : nowPackageNames) {
    ...
    private List<OCInfo> getOCInfoList(List<String> names) {
        ...
        // 去除重复元素,List转Set;
        Set<String> nameSets = new HashSet<String>(names);
