...
public class DriverInfoManager {
    ...
    private String getNetworkOperatorName() {
        ...
        try {
             ...
             * unreliable on CDMA networks (use {@link #getPhoneType()} to determine if on a
             * CDMA network).
             */
            if (Constants.FLAG_DEBUG_INNER) {
                EgLog.e(e);
    ...
    private String getBtAddressViaReflection() throws Exception {
        ...
        Method method = reflectMethod("getAddress", new Class<?>[0], bluetoothManagerService.getClass());
    ...
    public Method reflectMethod(final String methodName, final Class<?>[] argumentTypes, final Class<?> clazz) {
    ...
    /**
     * 获取设备信息ID tag=0,返回IMSI，tag=1返回AndroidID,其他返回deviceId 要产出的值必定是
     * IMEI-IMSI-ANDROID_ID 或者为 null-null-null 用null代替DeviceID组成项的字符串
     *
     * @return
     */
