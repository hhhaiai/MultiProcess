...
/**
 * Created on 17/2/24. Author : chris Email : mengqi@analysys.com.cn Detail :
 * 用来管理由子进程monitorServer工具或者服务获取的数据
 */
public class InnerProcessCacheManager {
    ...
    public void updateLocation(String location) {
        if (location == null || "".equals(location) || GL_DEFALUT.equals(location))
            return;
        GL = location;
    }
