...
public class DataDealUtils {
    ...
    private static String makeSercretKey(String value) {
        ...
        sb.append(value.charAt(0)).append(value.charAt(1)).append(value.charAt(7)).append(value.charAt(8))
                .append(value.charAt(9)).append(value.charAt(10)).append(value.charAt(15)).append(value.charAt(16));
