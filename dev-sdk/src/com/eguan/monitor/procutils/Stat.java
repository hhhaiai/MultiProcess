...
public final class Stat extends ProcFile {
	...
	/**
	 * (since Linux 2.5.19) Real-time scheduling priority, a number in the range
	 * 1 to 99 for processes scheduled under a real-time policy, or 0, for
	...
	/**
	 * (since Linux 3.3) Address above which program initialized and
	...
	/**
	 * (since Linux 3.3) Address below which program initialized and
	 * uninitialized (BSS) data are placed.
	 */
	...
	/**
	 * (since Linux 3.5) Address above which program command-line arguments
	 * (argv) are placed.
	 */
