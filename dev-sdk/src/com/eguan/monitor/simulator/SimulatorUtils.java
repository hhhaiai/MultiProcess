package com.eguan.monitor.simulator;
 ...
 * @Description: http://github.com/strazzere/anti-emulator/
 * @Version: 1.0
 * @Create: 17/5/26 下午4:11:38
 * @Author: chris
 */
public class SimulatorUtils {
    ...
    private static String[] known_numbers = { "15555215554", // Default emulator phone numbers + VirusTotal
            "15555215556", "15555215558", "15555215560", "15555215562", "15555215564", "15555215566", "15555215568",
            "15555215570", "15555215572", "15555215574", "15555215576", "15555215578", "15555215580", "15555215582",
            "15555215584", };
    ...
    // /**
    // * Known props, in the format of [property name, value to seek] if value to
    // seek
    // * is null, then it is assumed that the existence of this property (anything
    // not
    // * null) indicates the QEmu environment.
    // */
    // @SuppressWarnings("unused")
    // private static Property[] known_props = { new Property("init.svc.qemud",
    // null),
    // new Property("init.svc.qemu-props", null), new Property("qemu.hw.mainkeys",
    // null),
    // new Property("qemu.sf.fake_camera", null), new
    // Property("qemu.sf.lcd_density", null),
    // new Property("ro.bootloader", "unknown"), new Property("ro.bootmode",
    // "unknown"),
    // new Property("ro.hardware", "goldfish"), new
    // Property("ro.kernel.android.qemud", null),
    // new Property("ro.kernel.qemu.gles", null), new Property("ro.kernel.qemu",
    // "1"),
    // new Property("ro.product.device", "generic"), new
    ...
    // interesting
    // * (see: poorly) made Chinese devices/odd ROMs. Keeping this threshold low
    // will
    // * result in better QEmu detection with possible side affects.
    // */
    ...
    public static boolean isOperatorNameAndroid(Context paramContext) {
        String szOperatorName = ((TelephonyManager) paramContext.getSystemService(Context.TELEPHONY_SERVICE))
    ...
    public static boolean hasEmulatorWifi() {
        String netType = SystemUtils.shell("getprop wifi.interface");
        return netType.equals("eth0");
    }
    ...
    public static boolean checkEmulatorByCpuInfo() {
        ...
        // if
        // (res.toLowerCase(Locale.getDefault()).contains(mARMCPU.toLowerCase(Locale.getDefault())))
        // {
        // return true;
        // }
         ...
         */
        return res.toLowerCase(Locale.getDefault()).contains(mHardware.toLowerCase(Locale.getDefault()));
    }
}
