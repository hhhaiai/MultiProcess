...
public class AndroidAppProcess extends AndroidProcess {
    ...
    public AndroidAppProcess(int pid) throws IOException, NotAndroidAppProcessException {
        ...
        if (SYS_SUPPORTS_SCHEDGROUPS) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                // ProcessManager.log("name=%s, pid=%d, uid=%d, foreground=%b, cpuacct=%s,
                // cpu=%s",
            ...
            uid = status.getUid();
            // ProcessManager.log("name=%s, pid=%d, uid=%d foreground=%b", name, pid, uid,
            // foreground);
        }
     ...
     *            {@link PackageManager#GET_UNINSTALLED_PACKAGES} to modify the data
     *            returned.
