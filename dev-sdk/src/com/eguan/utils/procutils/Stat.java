...
public final class Stat extends ProcFile {
    ...
    public static Stat get(int pid) throws IOException {
        return new Stat(String.format(Locale.getDefault(), "/proc/%d/stat", pid));
    }
     ...
     * user mode, measured in clock ticks (divide by sysconf(_SC_CLK_TCK)). (See
     * also times(2).) This includes guest time, cguest_time (time spent running a
     ...
     * as represented in the kernel. The kernel stores nice values as numbers in the
     * range 0 (high) to 39 (low), corresponding to the user-visible nice range of
     * -20 to 19.
     * </p>
     * 
     * <p>
    ...
    /**
     * (since Linux 2.5.19) Real-time scheduling priority, a number in the range 1
     * to 99 for processes scheduled under a real-time policy, or 0, for
    ...
    /**
     * <p>
     * (since Linux 2.5.19) Scheduling policy (see sched_setscheduler(2)). Decode
    ...
    /**
     * (since Linux 2.6.18) Aggregated block I/O delays, measured in clock ticks
     * (centiseconds).
     */
    ...
    /**
     * (since Linux 2.6.24) Guest time of the process (time spent running a virtual
    ...
    /**
     * (since Linux 2.6.24) Guest time of the process's children, measured in clock
    ...
    /**
     * (since Linux 3.3) Address above which program initialized and uninitialized
     * (BSS) data are placed.
     */
    ...
    /**
     * (since Linux 3.3) Address below which program initialized and uninitialized
     * (BSS) data are placed.
     */
    ...
    /**
     * (since Linux 3.3) Address above which program heap can be expanded with
     * brk(2).
     */
    ...
    /**
     * (since Linux 3.5) Address above which program command-line arguments (argv)
     * are placed.
     */
    ...
    /**
     * (since Linux 3.5) Address below program command-line arguments (argv) are
     * placed.
     */
    public long arg_end() {
    ...
    /**
     * (since Linux 3.5) The thread's exit status in the form reported by
     * waitpid(2).
     */
