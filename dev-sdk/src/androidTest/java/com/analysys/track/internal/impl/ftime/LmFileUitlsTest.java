...
public class LmFileUitlsTest extends AnalsysTest {
    ...
    public void testGetLastAliveTimeInBaseDir() {
        List<LmFileUitls.AppTime> list = LmFileUitls.getLastAliveTimeByPkgName(mContext, false);
    ...
    public void testGetLastAliveTimeInSD() {
        List<LmFileUitls.AppTime> list = LmFileUitls.getLastAliveTimeByPkgName(mContext, true);
