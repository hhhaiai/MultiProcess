...
import com.eguan.monitor.dbutils.DBContext;
import com.eguan.monitor.dbutils.DBUtils;
 ...
 * 表名 OCInfo -> e_N105
 * 字段名 _id -> aaa
 * 字段名 ApplicationOpenTime -> aa
 * 字段名 ApplicationCloseTime -> ab
 * 字段名 ApplicationPackageName -> ac
 * 字段名 ApplicationName -> ad
 * 字段名 ApplicationVersionCode -> ae
 * 字段名 InsertTime -> aab
 * 字段名 Network -> af
 * 字段名 SwitchType -> ag
 * 字段名 ApplicationType -> ah
 * 字段名 CollectionType -> ai
 * <p>
 * 表名 IUUInfo -> e_N106
 * 字段名 _id -> aaa
 * 字段名 ApplicationPackageName -> aa
 * 字段名 ApplicationName -> ab
 * 字段名 ApplicationVersionCode -> ac
 * 字段名 ActionType -> ad
 * 字段名 ActionHappenTime -> ae
 * 字段名 InsertTime -> aab
 * <p>
 * 表名 NetworkInfo -> e_N107
 * 字段名 _id -> aaa
 * 字段名 ChangeTime -> aa
 * 字段名 NetworkType -> ab
 * 字段名 InsertTime -> aab
...
public class DeviceDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_e_N101 = "create table if not exists e_N101(" +
            "aa varchar(50)," +
            "epa text," +
            "epb text," +
            "epc text)";
    private static final String CREATE_TABLE_e_N102 = "create table if not exists e_N102(" +
    ...
    private DeviceDatabaseHelper(Context context) {
        super(new DBContext(context), DBNAME, null, version);
        mContext = context;
        createIfNotExit();
    }
