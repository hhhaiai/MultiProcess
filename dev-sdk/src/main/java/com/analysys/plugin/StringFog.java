...
public class StringFog {
    ...
    public final static class StringFogImpl implements IStringFog {
        ...
        public StringFogImpl() {
            hset.put("com.analysys.DevInfo",new byte[]{85, 64, 87, 92, 95, 71, 81, 82, 83, 64, 65, 23, 68, 66, 83, 86, 81, 0, 102, 93, 81, 73, 80, 57, 68, 85, 95, 77, 66, 21, 119, 71, 81, 64, 71});
            ...
            hset.put("imei",new byte[]{83, 75, 71, 122, 89, 67, 80, 47, 70, 81, 92, 73});
            hset.put("time",new byte[]{83, 75, 71, 107, 70, 75, 91, 8, 102, 73, 65, 92});
            hset.put("com.analysys.Helper",new byte[]{80, 79, 95, 88, 89, 69, 27, 15, 75, 67, 69, 92, 92, 31, 100, 124, 102, 91, 93, 90, 89, 67, 80});
            ...
            hset.put("event",new byte[]{83, 75, 71, 96, 85, 86, 65, 57, 68, 85, 95, 77});
