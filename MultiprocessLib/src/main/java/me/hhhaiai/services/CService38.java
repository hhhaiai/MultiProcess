...
public class CService38 extends Service {
    String NAME = CService38.class.getName();
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            startForeground(38, notification);
        }
    }
    ...
    public int onStartCommand(final Intent intent, int flags, int startId) {
        ...
        EThreadPool.runOnWorkThread(() -> {
            ServiceHelper.callback(CService38.this, intent);
        });
